$(document).ready(function(){
   ...
   $("#showSupplierInvouceYear").click(function(){
    ...
    if(yearC == ""){
     ...
     $.ajax({ 
      url:'dist/php/Acc/allSupplierInvoiceYear.php',
      type:"POST",
   ...
   $("#showSupplierInvouceQuarter").click(function(){
    ...
    if(yearC == ""){
     ...
     $.ajax({ 
      url:'dist/php/Acc/allSupplierInvoiceQuarter.php',
      type:"POST",
   ...
   $("#showSupplierInvouceMonth").click(function(){
    ...
    if(yearC == ""){
     ...
     $.ajax({ 
      url:'dist/php/Acc/allSupplierInvoiceMonth.php',
      type:"POST",
   ...
   $("#showSupplierSalesInvoice").click(function(){
    ...
    if(customerC == ""){
     ...
     $.ajax({ 
      url:'dist/php/Acc/allSupplierInvoiceCustomer.php',
      type:"POST",
  ...
  $("#showLimitSupplierInvoice").click(function(){
   ...
   if(sDate == ""){
    ...
    $.ajax({ 
     url:'dist/php/Acc/allSuppliersInvoiceData.php',
     type:"POST",
