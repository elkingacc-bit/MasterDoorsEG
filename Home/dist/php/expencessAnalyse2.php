...
<div class="table-responsive-lg">
 ...
 ?>
 <h3>Operation Expencess Analysis <small><?php echo $sYear; ?> </small>  </h3>    
 <table class="table table-bordered table-striped w-100 myTableExpencess">
  ...
  <tbody>
   <?php
    $getAccountCode="SELECT `accountCode`, `accountName` FROM `accountantcode` WHERE `codeLen` = 12 AND `accountCode` LIKE '312%'"; 
...
<script type="text/javascript">
 ...
 dom: 'Bfrtip',
       ...
       
       {
            ...
            text: 'Excel',
            extension: '.xlsx',
            title:'Operation Expencess_Analysis '+datetime,
            filename: function () {
