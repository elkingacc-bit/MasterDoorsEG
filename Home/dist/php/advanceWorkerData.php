...
<div class="table-responsive-lg">
 <table class='table table-sm table-bordered table-striped myTableAdvanceWorker w-100'>
  ...
  <tbody>
   <?php
    ...
    $empName=$employeeData['staffname'];
    $advanceBalance=0;
    $sqlAdvanceStatment="SELECT `advanceDate`, `recived`, `cashback`, `installment` FROM `advance` WHERE `recevedRef` = 2 AND `empId` = $empId";  
...
<script type="text/javascript">
 $(document).ready(function(){
  ...
  var table = $('.myTableAdvanceWorker').DataTable({
   //fixedHeader: true,
   //scrollY:'35vh',
   //scrollX: true,
   //scrollCollapse: true,
    ...
    buttons:[
     {
      ...
      text: 'Excel',
      extension: '.xlsx',
      title:'Advance For Staff '+datetime,
      filename: function () {
      return "Advance For Staff"},
