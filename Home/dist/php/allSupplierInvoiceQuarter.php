...
<?php
 ...
 $quarterC=$_POST['startQuarter'];
 echo"
  <input value='Purchaseing Invoice Year $sDate Quarter $quarterC' class='reportTitel' hidden>
  <h3 class='text-center text-body'>Purchaseing Invoice Year $sDate Quarter $quarterC</h3>
 ";
?>
<div class="table-responsive-lg">
 <table class='table table-sm table-bordered table-striped myTableSuppInvoQ w-100'>
  ...
  <tbody>
   <?php
    ...
    FROM `supplierInvoice` WHERE year(`suppliersInvoiceDate`) = $sDate AND quarter(`suppliersInvoiceDate`) = $quarterC";
...
<script type="text/javascript">
  ...
  var table = $('.myTableSuppInvoQ').DataTable({
   fixedHeader: false,
   scrollY:'35vh',
   scrollX: true,
   scrollCollapse: true,
