...
<?php
 ...
 echo"
  <input value='Sales Invoice $tYear Quarter $tQuarter' class='reportTitel' hidden>
  <h3 class='text-center text-body'>Sales Invoice $tYear Quarter $tQuarter</h3>
 ";
?>
<div class="table-responsive-lg">
 <table class='table table-sm table-bordered table-striped myTableSalesInvoYQ w-100'>
  ...
  <tbody>
   <?php
    ...
    `salesInvoictVat`,`totalInvoice`,`invoiceCollectAmount` FROM `salesInvoice` WHERE year(`salesInvoiceDate`) = $tYear AND quarter(`salesInvoiceDate`) = $tQuarter";
...
$(document).ready(function(){
  ...
  var table = $('.myTableSalesInvoYQ').DataTable({
   fixedHeader: false,
   scrollY:'35vh',
   scrollX: true,
   scrollCollapse: true,
