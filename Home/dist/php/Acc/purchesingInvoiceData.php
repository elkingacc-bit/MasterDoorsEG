...
var table = $('.myTablePaymentInvoice').DataTable({
 ...
 $(".showItems").click(function(){
  var rowId = $(this).val();
   $.ajax({
    url:'dist/php/Acc/supplierOrderItems.php',
    type:"POST",
    data:{orderId:rowId},
...
$(".showStockItems").click(function(){
  var invoiceId = $(this).val();
   $.ajax({
    url:'dist/php/Acc/supplierStockItems.php',
    type:"POST",
 ...
 $(".showPaied").click(function(){
  var invId = $(this).val();
  $.ajax({
   url:'dist/php/Acc/suuplierWithdrawalDetils.php',
   type:"POST",
   data:{orderId:invId},
 ...
 $(".suppliersInvoiceData").click(function(){
  var PONum = $(this).val();
  $.ajax({
   url:'dist/php/Acc/supplierInvoiceContant.php',
   type:"POST",
   data:{orderId:PONum},
 ...
 $(".editOfferPrices").click(function(){
  ...
  $.ajax({
   url:'dist/php/Acc/editPurchasesOrderData.php',
   type:"POST",
 ...
 $(".deleteOffer").click(function(){
  ...
  $.ajax({
   url:'dist/php/Acc/deletePurchasesOrder.php',
   type:"POST",
   data:{orderId:orderId},
 ...
 $(".PaiedsuppliersInvoiceData").click(function(){
  ...
  $.ajax({
   url:'dist/php/Acc/paiedSuppliersInvoiceData.php',
   type:"POST",
   data:{invId:empName},
...
$(".PaiedsuppliersStockInvoiceData").click(function(){
  var invNum =$(this).val();
  $.ajax({
   url:'dist/php/Acc/paiedSuppliersStockInvoice.php',
   type:"POST",
   data:{invId:invNum},
...
$(".manufacturOffer").click(function(){
  var invNum =$(this).val();
  $.ajax({
   url:'dist/php/Acc/purchasesOrderData.php',
   type:"POST",
   data:{poId:invNum},
   success: function(getPaiedStockData){
    $(".supplierInvoiceData").html('');
