...
<?php
 ...
 echo"
  <input value='Sales Invoice $tYear/$tQuarter' class='reportTitel' hidden>
  <h3 class='text-center text-body'>Sales Invoice $tYear/$tQuarter</h3>
 ";
?>
<div class="table-responsive-lg">
 <table class='table table-bordered table-striped myTableSalesInvoYM w-100'>
  ...
  <tbody>
   <?php
    ...
    `salesInvoictVat`,`totalInvoice`,`invoiceCollectAmount` FROM `salesInvoice` WHERE year(`salesInvoiceDate`) = $tYear AND month(`salesInvoiceDate`) = $tQuarter";
...
$(document).ready(function(){
  ...
  var table = $('.myTableSalesInvoYM').DataTable({
   fixedHeader: false,
   scrollY:'35vh',
   scrollX: true,
   scrollCollapse: true,
