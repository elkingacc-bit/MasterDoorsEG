...
<script type="text/javascript">
 $(document).ready(function(){
  $("#saveSallary").click(function(){
   ...
   $.ajax({
    url:'dist/php/Acc/saveWithdrawalSallary.php',
    type:"POST",
    data:{stafId:stafRow},
  ...
  $("#printSallary").click(function(){
   ...
   $.ajax({
    url:'dist/php/Acc/printWithdrawalSallary.php',
    type:"POST",
    data:{stafId:stafRowId},
    success: function(printWithdrawalData){
     window.open(`dist/php/Acc/printWithdrawalSallary.php?stafId= <?php echo $stafeId ?>`, '_blank');
    }
   });
   return false;
  });
