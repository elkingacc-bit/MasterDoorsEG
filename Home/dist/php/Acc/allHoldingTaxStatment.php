...
<div class="table-responsive-lg">
 <table class="table table-sm table-bordered table-striped myTableHoldingTax w-100">
  ...
  <tbody>
   <?php
    ...
    WHERE `transactionCode` = 21210110000  AND `transactionsYear` = $sYear ORDER BY `transactionsDate` ASC";  
...
<script type="text/javascript">
 $(document).ready(function(){
  ...
  var table = $('.myTableHoldingTax').DataTable( {
 ...
 dom: 'Bfrtip',
       ...
       
       {
            ...
            text: 'Excel',
            extension: '.xlsx',
            title:'HoldingTax_Statment '+datetime,
            filename: function () {
            return "HoldingTax_Statment" },
        ...
        
    {
      ...
      text: 'Print',
      className: 'btn btn-secondary',
      title:'{Master Doors EG} | HoldingTax_Statment '+datetime,
      footer: true,
       exportOptions: {
