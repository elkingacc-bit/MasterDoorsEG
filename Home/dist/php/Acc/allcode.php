...
<script type="text/javascript">
 $(document).ready(function(){
  ...
  $(".saveEditCode").click(function(){
   ...
   $.ajax({
    url:"dist/php/Acc/saveCodeEditing.php",
    type:"POST",
  ...
  $(".dellCode").click(function(){
   ...
   if (msg1){
    ...
    if (msg2) {
     $.ajax({
      url:"dist/php/Acc/deleteCode.php",
      type:"POST",
      data:{codeNum:rowId},
      success: function(doneDelete){
       if(doneDelete == 1){$(".prviewData").load("dist/html/Acc/allCode.html");}
  ...
  $(".rename").click(function(){
   var codId =$(this).val();
   $.ajax({
    url:"dist/php/Acc/dataToEdit.php",
    type:"POST",
    data:{rowNum:codId},
