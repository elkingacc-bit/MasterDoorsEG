...
<?php
 ...
 echo"
  <input value='Sales Invoice $tYear' class='reportTitel' hidden>
  <h3 class='text-center text-body'>Sales Invoice $tYear</h3>
 ";
?>
<div class="table-responsive-lg">
 <table class='table table-sm table-bordered table-striped myTableSalesInvoYear w-100'>
  ...
  <tbody>
   <?php
    ...
    `salesInvoictVat`,`totalInvoice`,`invoiceCollectAmount` FROM `salesInvoice` WHERE year(`salesInvoiceDate`) = '$tYear'";
...
$(document).ready(function(){
  ...
  var table = $('.myTableSalesInvoYear').DataTable({
   fixedHeader: false,
   scrollY:'35vh',
   scrollX: true,
   scrollCollapse: true,
