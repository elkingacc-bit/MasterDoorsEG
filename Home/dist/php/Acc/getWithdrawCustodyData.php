...
<script type="text/javascript">
 $(document).ready(function(){ 
  ...
  $.ajax({ 
   url:'dist/php/Acc/cashbackdetils.php',
   type:"POST",
   data:{femp:emp},
  ...
  //
  $("#acountant").load("dist/php/Acc/allcodeCashback.php");
  $(".projectName").load("dist/php/Acc/projectsList.php");
  //
  ...
  $("#saveCustodyCashback").click(function(){
   ...
   {
    $.ajax({ 
     url:'dist/php/Acc/saveNewCashbackCustody.php',
     type:"POST",
