...
<?php
 ...
 $supplier=(int)$_POST['customer'];
 $sqlFirstLevelData="SELECT `suppliername` FROM `allsuppliers` WHERE `suppliercode` = $supplier";
...
<div class="table-responsive-lg">
 <table class='table table-sm table-bordered table-striped myTableSuppInvoQS w-100'>
  ...
  <tbody>
   <?php
    ...
    FROM `supplierInvoice` WHERE `supplierCode` = $supplier ORDER BY `suppliersInvoiceDate` ASC";
...
<script type="text/javascript">
  ...
  var table = $('.myTableSuppInvoQS').DataTable({
   fixedHeader: false,
   scrollY:'35vh',
   scrollX: true,
   scrollCollapse: true,
