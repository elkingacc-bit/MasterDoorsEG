...
$idRowJobOld=$_GET['JobId'];
	...
	$sqlGetAllNewJob="SELECT `customer`, `localref`, `vatstatus`, `projectName` FROM `job` WHERE 
	`jobId` = $idRowJobOld";
...
<table class="table" height="auto" style="border:solid; border:1px">
	...
	$sqlFetchOldJob="SELECT `id`, `doortype`, `doorspecs`, `motorspecs`, `doorprice`, `doorqty`,
	`totalprice` FROM `autodoorsoffer` WHERE  `jobid` = $idRowJobOld"; 
...
echo "
   ...
   <td class='col-sm-1 td' style='width:10%' align='center'>".number_format($resFetchOldJob['doorprice'])."
   </td>
...
$SN++;
 ...
 ?>
        	...
        	<?php
				$sqlGetTotalVal = "SELECT SUM(`totalprice` ) AS Total FROM `autodoorsoffer` 
				...
				$sqlGetAllQTY="SELECT SUM(`doorqty`) AS AllQTY FROM `autodoorsoffer` 
				WHERE `jobid` = $idRowJobOld";
      ...
      <tr style="border-style:solid; border-width:2px; border-color:#000000; ">
        ...
        <td class='th' align="center"><b><?php echo $resAllQTY['AllQTY'];?></b></td>
       ...
       <tr style="display:<?php echo $vatStat;?>">
     	<td class='th' align="center"  colspan="5"><b>VAT 14%
       </b> </td>
       ...
       <tr style="border-style:solid; border-width:2px; border-color:#000000; display:<?php echo $vatStat;?>">
     	<td class='th' align="center"  colspan="5"><b>Total Including VAT 
        </b> </td>
