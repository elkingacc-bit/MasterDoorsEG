...
<table class="table" height="auto" style="border:solid; border:1px">
    	...
    	<thead style="border-style:solid; border-width:2px; border-color:#000000;" class='bg-light'>
            ...
            <td class='col-sm-1' style="width:15%" ><b>&nbsp;Part No.</b></td>
            <td class='col-sm-2' style="width:35%" align="center"><b>&nbsp;Item</b></td>
	...
	$sqlFetchOldJob="SELECT `id`, `descripcode`, `descripqty`, `descripprice`, `totalprice` FROM
    `stockoffers` WHERE `jobref` = $idRowJobOld"; 
...
echo "
   ...
   <td class='col-sm-1 td' style='width:5%' align='center'>$SN </td>
   	<td class='col-sm-1 td' style='width:15%'>&nbsp;".$PartNum."</td>
     
	<td class='col-sm-2 td' style='width:35%' align='left'>&nbsp;".$descName."</td>
     
    <td class='col-sm-2 td'style='width:30%'  align='left'>".$resFetchOldJob['descripqty']."</td>
  
   <td class='col-sm-1 td'style='width:5%'  align='center'>".$resFetchOldJob['descripprice']."</td>
...
$SN++;
 ...
 ?>
        	...
        	<?php
				$sqlGetTotalVal = "SELECT SUM(`totalprice`) AS Total FROM `stockoffers` 
      ...
      <tr style="border-style:solid; border-width:2px; border-color:#000000; ">
       ...
       <tr style="display:<?php echo $vatStat;?>">
     	<td class='th' align="center"  colspan="4"><b>VAT 14%
       </b> </td>
       ...
       <tr style="border-style:solid; border-width:2px; border-color:#000000; display:<?php echo $vatStat;?>">
     	<td class='th' align="center"  colspan="4"><b>Total Including VAT 
        </b> </td>
