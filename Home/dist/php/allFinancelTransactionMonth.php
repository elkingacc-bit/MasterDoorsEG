...
<div class="table-responsive-lg">
 <table class='table table-sm table-bordered table-striped myTableFinancalTransactionYM w-100'>
  ...
  <tbody>
   <?php
    ...
    WHERE `transactionsYear` = $tYear AND `transactionsMonth` = $tQuarter";
...
<script type="text/javascript">
 $(document).ready(function(){
  ...
  var table = $('.myTableFinancalTransactionYM').DataTable({
   fixedHeader: false,
   scrollY:'35vh',
   scrollX: true,
   scrollCollapse: true,
