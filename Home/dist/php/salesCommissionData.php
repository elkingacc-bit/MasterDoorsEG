 ...
 <tbody>
  <?php
   ...
   while($TotalPO=mysqli_fetch_assoc($queryTotalPO)){
    ...
    $receiveProgress=($validComm / $TotalPO['test'])*100; 
    if($receiveProgress  <= 25 ){
   ...
   $supBrog2=($validComm2 / $TotalPO2['test2'])*100;
   if($supBrog2  <= 25 ){
...
<script>
 $(document).ready(function(){
  $(".showData").click(function(){
   var rowId = $(this).val();
   $.ajax({
    url:'dist/php/getSalesCommissionData.php',
    type:"POST",
    data:{orderId:rowId},
